...
namespace MvcPhoenix.DataLayer
{
    ...
    public partial class tblOrderItem
    {
        ...
        public string ImportItemID2 { get; set; }
        ...
        public Nullable<bool> DelivNoteCreated { get; set; }
        public Nullable<int> ExternalID { get; set; }
        public string SFDCID { get; set; }
        public Nullable<int> Batch { get; set; }
        public string RequestCenterID { get; set; }
        ...
        public string PaUniqueID { get; set; }
        public Nullable<bool> DoNotCarry { get; set; }
        public Nullable<bool> SV { get; set; }
        public Nullable<bool> KitPrice { get; set; }
        public string ItemNotes { get; set; }
        public string KitFlag { get; set; }
        public string EMNLineNo { get; set; }
        public string EMNItemRefNo { get; set; }
        public string EMNPMNo { get; set; }
        public string EMNMaterialName { get; set; }
        public string EMNStatusCode { get; set; }
